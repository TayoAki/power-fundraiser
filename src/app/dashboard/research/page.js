            ...
            >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginTop: '6px', fontSize: '0.8125rem', color: '#64748b' }}>
                        {/* Only show location for foundations, not government grants */}
                        {!isGovernmentGrant && (
                        <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" />
                            </svg>
                            {donor.location || `${donor.city || 'N/A'}, ${donor.state || 'N/A'}`}
                        </span>
                        )}
                        <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        {/* Show deadline for government grants */}
                        {isGovernmentGrant && donor.deadline && (
                            <span style={{ 
                                display: 'flex', 
                                alignItems: 'center', 
                                gap: '4px',
                                color: donor.deadline === 'Check Website' ? '#64748b' : '#dc2626',
                                fontWeight: donor.deadline !== 'Check Website' ? 600 : 400,
                            }}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
